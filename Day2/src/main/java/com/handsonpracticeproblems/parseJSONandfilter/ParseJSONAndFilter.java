package com.handsonpracticeproblems.parseJSONandfilter;


import com.practiceproblems.convertjavaobjecttojson.Student;
...
public class ParseJSONAndFilter {
    public static void main(String[] args) {
        try {
            ...
            Student s2 = new Student("John", 26, new String[]{"physics", "chemistry", "biology"});
            Student s3 = new Student("Alice", 23, new String[]{"maths", "biology", "physics"});
            students.add(s1);
            students.add(s2);
            students.add(s3);
